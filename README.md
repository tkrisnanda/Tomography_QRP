...
3. The main codes are labelled aa0GH...py - aa7GH...py. TK_basics.py contains helful functions. The rest of the files are theoretically generated and experimental data.
